...
export const slidesOutros = [
  ...
  {
    content: <img src="https://i.ibb.co/f06ZSHw/le-6.jpg" alt="le-6" border="0" />
  },
  {
    content: <img src="https://i.ibb.co/7tqfTZN/le-7.jpg" alt="le-7" border="0" />
  },
  {
    content: <img src="https://i.ibb.co/4SjPFyK/le-8.jpg" alt="le-8" border="0" />
  },
  {
    content: <img src="https://i.ibb.co/4sYHVdf/le-11.jpg" alt="le-11" border="0" />
  },
]